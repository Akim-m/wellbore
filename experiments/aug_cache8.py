...
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "aug_cache8.pkl")
MIN_PS = 50
FRACS = (0.35, 0.45, 0.55, 0.65, 0.75, 0.85, 0.93, 1.0)   # synthetic PS as fraction of the true PS
